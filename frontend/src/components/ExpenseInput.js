...
const SPLIT_OPTIONS = [
    {
        value: "DEFAULT",
        label: "기본",
        description: "사람 인원수로 나누어 정산합니다."
    },
    {
        value: "DONE",
        label: "정산 완료",
        description: "이미 정산이 완료된 경우입니다.\n정산 내역에만 추가됩니다."
    },
    {
        value: "RATE_CHANGE",
        label: "비율 조정",
    ...
    },
    {
        value: "SET_DIVISION",
        label: "가격 지정",
        description: "정해진 금액을 내기로 한 인원이 있다면 해당 입력란에 금액을 입력해주세요."
    },
    {
        value: "DRINK_SEPARATE",
        label: "주류 별도",
        description: "술 값은 따로 정산하기로 한 경우입니다.\n술을 마신 사람을 체크하고, 술 값을 입력해주세요."
    },
    {
        value: "TREAT",
        label: "쏜다",
        description: "결제자가 쏘기로 한 경우입니다."
    }
];
